...
class OpenSearchAPI:
    ...
    def search_alerts(self, severity_levels=None, start_time=None, end_time=None, 
        ...
        try:
            ...
            # Define Misc Events / Noise criteria
            # Rule IDs confirmed as high-volume infrastructure noise (SOC analysis, Apr 2026):
            #   4804  = SonicWall IKEv2 Unable to find IKE SA       (~295k/day, lvl 3)
            #   4803  = SonicWall error message                      (~53k/day,  lvl 4)
            #   61102 = Windows DCOM System error (Event ID 10016)   (~47k/day,  lvl 5)
            #   61107 = TacticalRMM Agent terminated                 (~18k/day,  lvl 5)
            #   60608 = Report signature summary                     (~14k/day,  lvl 4)
            #   60642 = Software protection service scheduled        (~8.8k/day, lvl 3)
            #   750   = Registry Value Integrity Checksum Changed    (lvl 5)
            #   751   = Registry Value Entry Deleted                 (lvl 5)
            #   752   = Registry Value Entry Added                   (lvl 5)
            #   594   = Registry Key Integrity Checksum Changed      (lvl 5)
            #   60106 = Misc low-value events
            NOISE_RULE_IDS = [
