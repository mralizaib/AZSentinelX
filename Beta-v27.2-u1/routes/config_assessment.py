...
config_assessment_bp.before_request(make_blueprint_permission_check('config_assessment'))
...
def download_csv(agent_id, policy_id):
    ...
    try:
        ...
        writer.writerow(['REBIZ Sentinel X — Configuration Assessment Report'])
...
def download_xlsx(agent_id, policy_id):
    ...
    try:
        ...
        title_cell = ws.cell(row=1, column=1, value='REBIZ Sentinel X — Configuration Assessment Report')
...
def download_pdf(agent_id, policy_id):
    ...
    try:
        ...
        story.append(Paragraph('REBIZ Sentinel X — Configuration Assessment Report', title_style))
