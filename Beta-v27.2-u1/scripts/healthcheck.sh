...
echo -e "${GREEN}REBIZ Sentinel X Health Check${NC}"
echo "----------------------------------------"
...
echo -n "Checking REBIZ Sentinel X containers... "
...
echo ""
echo "If all checks passed, REBIZ Sentinel X is running correctly."
echo "If any warnings or errors were reported, please check the specific components."
echo ""
echo "You can access REBIZ Sentinel X at: http://10.144.90.95:5000"
