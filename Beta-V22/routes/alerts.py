...
def view_alert(alert_id):
    ...
    try:
        ...
        return render_template('alert_details.html', alert=alert_data)
    except Exception as e:
    ...
    try:
        ...
        if alert.is_fim():
            ...
            if fim_data and 'results' in fim_data and fim_data['results']:
                ...
                subject = (
                    f"[ByteIT Sentinel X] FIM Alert — File {action}: "
                ...
                subject = (
                    f"[ByteIT Sentinel X] FIM Alert — File MODIFIED: "
        ...
        if alerts_data and 'results' in alerts_data and len(alerts_data['results']) > 0:
            ...
            subject = f"[ByteIT Sentinel X] Test Alert — {alert.name}"
...
<h2 style="color:#0d1b4b;">ByteIT Sentinel X — Test Alert</h2>
