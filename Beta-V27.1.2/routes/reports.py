      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td style="padding-left:16px;vertical-align:middle;">
            <div style="font-size:10px;text-transform:uppercase;letter-spacing:2px;color:rgba(255,255,255,0.65);margin-bottom:4px;">ByteIT SentinalX · Beta-V27.1.2</div>
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td style="color:rgba(255,255,255,0.7);font-size:11px;line-height:1.8;">
            <strong style="color:#fff;">ByteIT SentinalX</strong> · Beta-v18<br>
