...
def _configure_one_device(app, job_id, device_idx, device, global_city, global_state):
    ...
    try:
        ...
        manager_pw = manager_password_raw or f"{initials}_man12"
...
def download_template(fmt):
    ...
    if fmt == 'csv':
        ...
        instructions = [
            ...
            ('manager_password', 'Optional', 'Manager account password. Defaults to <client_initials>_man12. Leave both manager fields and create_manager blank to skip the manager account entirely for this device.'),
