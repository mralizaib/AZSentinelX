...
def configure_users():
    ...
    # default password follows the PowerShell reference standard (editable
    # via manager_password), e.g. "RC_man12" for client initials "RC".
    manager_username = manager_username_input or 'manager'
    manager_password = manager_password_input or f"{initials}_man12"
