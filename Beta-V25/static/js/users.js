...
const ROLE_OPTIONS = [
    ...
    { value: 'dvr_technician',        label: 'DVR Technician',        color: 'warning text-dark' },
    { value: 'senior_dvr_technician', label: 'Senior DVR Technician', color: 'warning text-dark' },
...
const ROLE_HINTS = {
    ...
    dvr_technician:        'DVR Configuration only',
    senior_dvr_technician: 'DVR Configuration, Bulk DVR, Storage Management',
