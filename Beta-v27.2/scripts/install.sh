...
echo -e "${GREEN}REBIZ Sentinel X Installation Script${NC}"
echo "----------------------------------------"
echo -e "${YELLOW}This script will install REBIZ Sentinel X on your system.${NC}"
echo ""
...
read -p "Do you want to set up REBIZ Sentinel X as a systemd service? (y/n): " SETUP_SERVICE
...
# Final instructions
echo ""
echo -e "${GREEN}REBIZ Sentinel X has been installed successfully!${NC}"
echo "----------------------------------------"
echo "Next steps:"
